export default function getPosts() {
  return Promise.resolve().then(() => [
    ...
    },
    {
      ...
      body: "qui consequuntur ducimus possimus quisquam amet similique suscipit porro ipsam amet  os veritatis officiis exercitationem vel fugit aut necessitatibus totam omnis rerum consequatur expedita quidem cumque explicabo",
    },
  ]);
}
